...
const IntroOne = () => {
  return (
    <div className='h-full w-full relative'>
      ...
      <Link to ="/introScreen2" className='absolute bottom-2 right-2' >
        <button className='hover:scale-105'><img src="/src/assets/startbtn.png" alt="start" className='h-[90px]'/></button>
      </Link>
    </div>
  )
}
